# EmPeKa - MPK Wroc³aw API

Private API for retrieving public transport arrival times for MPK Wroc³aw, using GTFS data and real-time vehicle positions.
...
MPK Wroc³aw data is provided under an open license.
